...
## [2026.9.22] - 2026-09-26

- Document and test that computers read the first status byte of the merged Bluetooth marker macOS reports, which always reflects whether the meter's computer list is open.
